...
export function SignUp() {
  ...
  useEffect(() => {
    const randomExternalId = `atmo-${Math.random()
      .toString(36)
      .substring(2, 10)}`;
        ...
        {step === 2 && (
          <div className="cloud-select fade-in">
            ...
            <div className="cloud-grid">
              ...
              <div
                className={`cloud-card ${
                  connectedClouds.Azure ? "disabled" : ""
                }`}
              >
          ...
          <div className="aws-connect fade-in">
            ...
            <div className="arn-input flex column">
              ...
              <input
                ...
                value={awsConfig.arn}
                onChange={(e) =>
                  setAwsConfig((prev) => ({ ...prev, arn: e.target.value }))
                }
              />
            </div>
